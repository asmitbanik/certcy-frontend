    ...
    <Layout pageTitle="Career Pivot">
      <div className="space-y-8">
        ...
        >
          <CarouselContent>
            {careerPaths.map((path) => (
              <CarouselItem key={path.id} className="md:basis-1/2">
                <div className="bg-certcy-cardbg border border-gray-800/50 hover:border-blue-500/30 transition-all duration-300 hover:shadow-lg hover:shadow-blue-500/10 p-6 rounded-lg">
                  <div className="flex items-start justify-between mb-4">
                    <div>
                      <HoverCard>
                        <HoverCardTrigger>
                          <h3 className="text-xl font-bold text-white cursor-help">{path.title}</h3>
                        </HoverCardTrigger>
                      ...
                      <p className="text-certcy-text-secondary mt-2">{path.description}</p>
                    </div>
                    <Badge 
                      variant="outline" 
                      className={cn(
          ...
          <CarouselPrevious className="bg-certcy-cardbg border-gray-800 text-white hover:bg-gray-800" />
          <CarouselNext className="bg-certcy-cardbg border-gray-800 text-white hover:bg-gray-800" />
        </Carousel>
      </div>
    </Layout>
  );
